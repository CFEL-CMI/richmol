...
# Apply static field along Y axis.
###################################################################
...
field_y = 100000 * 100 # 100 kV/cm in units V/m
...
enr_file = open("stark_energies_fy" + str(round(field_y,1)) + ".txt", 'w')
...
tran_file = open("stark_transitions_fy" + str(round(field_y,1)) + ".txt", 'w')
