Matrix elements of dipole moment and polarizability for camphor molecule (R-enantiomer) stored in the old-format richmol files.
The calculations were done using cmirichmol (older version of richmol), using the following molecular parameters:
